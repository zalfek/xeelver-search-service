...
@AllArgsConstructor
@NoArgsConstructor
public class AmadeusHotelRepository implements HotelRepository{

    private final static Logger LOGGER = Logger.getLogger(AmadeusHotelRepository.class.getName());
